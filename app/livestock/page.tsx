            ...
            <Card>
              <CardContent className="p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="text-2xl font-bold text-red-600">{sick}</div>
                ...
                <>
                  ...
                  <div className="lg:hidden space-y-4">
                    ...
                    {filteredAnimals.length === 0 && (
                      <div className="text-center py-10 text-gray-500">No animals found.</div>
                    )}
                  </div>
                  ...
                  <div className="hidden lg:block overflow-x-auto" style={{ maxHeight: 300, overflowY: 'auto' }}>
                    <table className="w-full">
                      ...
                      <tbody>
                        ...
                        {filteredAnimals.length === 0 && (
                          <tr>
                            <td colSpan={7} className="text-center py-10 text-gray-500">No animals found.</td>
                          </tr>
                        )}
                      </tbody>
                    </table>
                  ...
                  <div className="flex justify-between items-center mt-6">
                    ...
                    <Button
                      ...
                      disabled={page >= (pageSize > 0 && total > 0 ? Math.max(1, Math.ceil(total / pageSize)) : 1)}
                    >
                      Next
                    </Button>
                  </div>
