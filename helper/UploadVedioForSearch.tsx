...
export default function UploadVedioForSearch({
  onVideoCapture,
}: {
  ...
  if (cameraMode) {
    return (
      <div className="w-full">
        ...
        <h1 className="text-4xl font-bold mb-2">{t("search_cow")}</h1>
    ...
    <div className="w-full">
      {recordedVideo ? (
        ...
        >
          ...
          <p className="text-xs text-gray-500 mt-4">{t("supported_formats")}</p>
        </div>
      )}
